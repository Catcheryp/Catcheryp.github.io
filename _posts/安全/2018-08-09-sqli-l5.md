...
![](http://fight0days.cn/2019-07-06-103534.jpg)

2).开始查询数据，取数据库数据，然后查看虚拟表存在不，不存在则插入新记录，存在则`count(*)`字段直接加1
![](http://fight0days.cn/2019-07-06-103536.png)
...
![](http://fight0days.cn/2019-07-06-103539.jpg)
