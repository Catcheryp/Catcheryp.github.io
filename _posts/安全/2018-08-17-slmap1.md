...
nctf 上的一道宽字节注入的[题目](http://chinalover.sinaapp.com/SQL-GBK/index.php?id=1)<br>
...
来自：[http://www.youtube.com/user/inquisb/videos](http://www.youtube.com/user/inquisb/videos)

**1.Extensively fingerprint the back-end database management system, enumerate banner, session user, current database, users, users' password hashes and databases**<br>
version: 0.8<br>
target DB: MySQL 5.1<br>
target web application: Apache 2.2 / PHP 5.2<br>
targte OS: Debian GNU/Linux 5.0<br>
...
**2.Retrieve the database management system banner and enumerate the password hash(es) for database session user via UNION query SQL injection**<br>
version: 0.8<br>
target DB: Oracle 10.2 Enterprise Edition<br>
target web application: Apache 2.2 / PHP 5.2<br>
targte OS: Debian GNU/Linux 5.0<br>
...
**3.Dump only from the second to the third entry of column surname of table users**<br>
version: 0.8<br>
target DB: SQL Server 2005<br>
target web application: IIS6.0 / ASP<br>
targte OS: Win2003 Service Pack 2<br>
```
...
[sqlmap document](https://github.com/sqlmapproject/sqlmap/wiki/Usage)<br>
[http://www.vuln.cn/1992](http://www.vuln.cn/1992)<br>
乌云知识库还有几篇不错的文章
